...
const Superintendent = () => {
  ...
  const pageData = {
    ...
    subTitle2: "We gladly help with projects in Burleson, Alvarado, TX and nationwide",
    subDescription: "Having an experienced superintendent on your job site can set your project up for success. TRYCON ENTERPRISES can provide you with temporary or start-to-finish construction management services. Our site supervisors have earned the trust of clients in Burleson, Alvarado, TX and throughout the country.",
    subDescription2: "",
