...
const Commercial = () => {
  ...
  const pageData = {
    ...
    subDescription: "Whether you’re interested in remodeling a retail space or building a house from the ground up, TRYCON ENTERPRISES will bring your needs to life. Our unique skill set comes from 20+ years of big-box retail project management and 30+ years of construction management experience. Contact us today for help with your project nationwide.",
    subDescription2: "",
    offeringTitle: "Offering services for any type of business",
    offeringImage: "/services/business.webp",
    imageAlt: "Business",
    offeringDescription: "Bring your vision to life with our commercial construction services. We offer:",
    offerings: [
